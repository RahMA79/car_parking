import 'package:car_parking/Components/HomePage.dart';
...
class OnBoardingPageState extends State<OnBoardingPage> {
  ...
  void _onIntroEnd(context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
          builder: (_) =>
              const HomePage()), // هنا هتحطى بقى انه يتنقل ل login page
    );
  }
    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          ...
          image: _buildImage('assets/onboarding1.jpg'),
        ...
        PageViewModel(
          ...
          image: _buildImage('assets/onboarding2.jpg'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          ...
          image: _buildImage('assets/onboarding3.jpg'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Let's Go !!",
